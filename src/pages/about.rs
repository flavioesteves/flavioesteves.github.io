...
const RESUME_2: &str = "With six years of experience in developing custom applications and working with the ServiceNow Platform, I have now decided to embrace a fresh challenge by returning to my coding roots and moving away from Low-Code environments.";
