...
const RESUME_2: &str = "After six years of building custom applications on the ServiceNow platform, I'm eager to explore new coding challenges and expand my technical horizons beyond low-code environments.";
