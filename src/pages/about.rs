...
const RESUME_1: &str = "Hello, my name is Flávio Esteves, and I embarked on my journey as a Software Developer five years ago when I enrolled in a full-stack developer Bootcamp focused on Java. Since then, I have been captivated by the opportunity to learn something new every day and apply that knowledge in practical ways.";
const RESUME_2: &str = "With five years of experience in developing custom applications and working with the ServiceNow Platform, I have now decided to embrace a fresh challenge by returning to my coding roots and moving away from Low-Code environments.";
